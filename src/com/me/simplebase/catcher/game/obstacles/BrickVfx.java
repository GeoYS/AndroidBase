...
public class BrickVfx implements Vfx{
	...
	public BrickVfx(float centreX, float centreY) {
	...
	public void draw(SpriteBatch batch) {
		batch.draw(Textures.DEBRIS_PARTICLE, p1.getX(), p1.getY());
		batch.draw(Textures.DEBRIS_PARTICLE, p2.getX(), p2.getY());
		batch.draw(Textures.DEBRIS_PARTICLE, p3.getX(), p3.getY());
		batch.draw(Textures.DEBRIS_PARTICLE, p4.getX(), p4.getY());
	}
